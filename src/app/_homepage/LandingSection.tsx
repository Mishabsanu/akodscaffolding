...
const bgImg = '/BANNER/45.jpg';
const overlayImg = '/BANNER/45.jpg';
	...
	return (
		...
		>
			...
			<div className='landingGreeting'>
				<p className='head'>Building Trust</p>
				<p className='subHead'>One Scaffold at a Time</p>

				<p className='desc'>
					At AKOD Scaffolding, we don't just provide scaffolding; we build
					lasting relationships with our clients.
				</p>

				<p className='desc'>
					Our reliable scaffolding solutions ensure that every project is
					supported by the best materials and service,
				</p>

				<p className='desc'>
					promoting trust and safety in every construction.
				</p>
